...
public:
	...
	void drawBox(IplImage *img, IplImage *processedImg, CvRect *r)
	{
		...
		std::cout << "------------------------------------------------------" << std::endl;
		std::cout << "Face position: " << this->topLeftPoint.x << ", " << this->topLeftPoint.y << std::endl;
		std::cout << "Face dimensions: " << this->currentFaceWidth<< " by " << this->currentFaceHeight << std::endl;
		std::cout << "------------------------------------------------------" << std::endl;
		//std::cout << "Left eyebrow: " << this->leftEyebrowLoc.x << ", " << this->leftEyebrowLoc.y << std::endl;
		//std::cout << "Right eyebrow: " << this->rightEyebrowLoc.x << ", " << this->rightEyebrowLoc.y << std::endl;
		//std::cout << "Left eye: " << this->leftEyeLoc.x << ", " << this->leftEyeLoc.y << std::endl;
		//std::cout << "Right eye: " << this->rightEyeLoc.x << ", " << this->rightEyeLoc.y << std::endl;
		//std::cout << "Mouth top: " << this->mouthTopLoc.x << ", " << this->mouthTopLoc.y << std::endl;

		// measurements are relative to face size

		//put this where new face is initialized				
		nBrowDistance = (this->rightEyebrowLoc.x - this->leftEyebrowLoc.x)/this->currentFaceWidth;
		nLeftEyebrowRaised = (this->leftEyeLoc.y - this->leftEyebrowLoc.y)/this->currentFaceHeight;
		nRightEyebrowRaised = (this->rightEyeLoc.y - this->rightEyebrowLoc.y)/this->currentFaceHeight;
		nMouthOpen = (this->mouthBottomLoc.y - this->mouthTopLoc.y)/this->currentFaceHeight;
		//nMouthSmile = (this->mouthTopLoc.y - (this->mouthLeftLoc.y + this->mouthRightLoc.y)/2)/currentFaceHeight;
		...
		double curMouthOpen = (this->mouthBottomLoc.y - this->mouthTopLoc.y)/this->currentFaceHeight;
		//double curMouthSmile = (this->mouthTopLoc.y - (this->mouthLeftLoc.y + this->mouthRightLoc.y)/2)/currentFaceHeight;
		...
		double diffMouthOpen = (curMouthOpen - nMouthOpen) / (curMouthOpen + nMouthOpen);
